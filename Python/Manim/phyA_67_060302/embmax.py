...
class MaxentangleEmbezzlingState(Scene):
    def construct(self):
        ...
        for i in range(20):
            if i%2 == 0:
                expanded_20_values.append(initial_10_values[i//2])
            elif i%2 ==1:
                expanded_20_values.append(0)

        for i in range(20):
            if expanded_20_values[i] == 0:
                expanded_20_values[i] = expanded_20_values[i-1]
