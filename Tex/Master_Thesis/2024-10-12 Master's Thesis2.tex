...
and the Josephson junction increases. The coupling strength used in this simulation is in the ~DSC range, 
including the range from the rotating wave approximation is valid to impossible.
\begin{figure}[H]
